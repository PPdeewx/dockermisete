        ...
        <form @submit.prevent="submitForm">
          <div class="form-grid">
            <div class="form-group full-width">
              ...
              <div class="read-only-text">{{ currentUser?.prefix_th }} {{ currentUser?.firstname_th }} {{
                currentUser?.lastname_th }}</div>
            </div>
            ...
            <div class="form-group full-width">
              ...
              <div class="radio-group">
                <label><input type="radio" v-model="leaveForm.timePeriod" value="morning">
                  ครึ่งวันเช้า</label>
                <label><input type="radio" v-model="leaveForm.timePeriod" value="afternoon">
                  ครึ่งวันบ่าย</label>
            ...
            <div class="form-group full-width">
              <label for="substitute">ผู้ปฏิบัติงานแทน <span class="required">*</span></label>
              <AutoComplete
                id="substitute"
