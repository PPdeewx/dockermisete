      ...
      <ul class="nav-menu">
        ...
        <li class="nav-item active has-submenu">
          ...
          <ul class="submenu">
            ...
            <li><a href="#" class="submenu-link active">รายการอนุมัติการลาปฏิบัติงานนอกสถานที่</a></li>
    ...
    <div class="main-content">
      <div class="top-bar">
        <div class="breadcrumbs">
          <span><i class="fas fa-home"></i> หน้าหลัก > รายการอนุมัติการปฏิบัติงานนอกสถานที่</span>
        </div>
      ...
      <div class="content-container">
        <div class="header-with-button">
          <h2><i class="fas fa-calendar-check"></i> รายการอนุมัติการปฏิบัติงานนอกสถานที่</h2>
        </div>
