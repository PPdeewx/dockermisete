      ...
      <div class="content-container">
        <div class="header-with-buttons">
          ...
          <div class="header-buttons">
            <button class="btn-action btn-green" @click="requestLeaveForOther">
              <i class="fas fa-plus"></i> ลาให้คนอื่น
            </button>
            <button class="btn-action btn-green" @click="requestLeave">
              <i class="fas fa-plus"></i> ขออนุมัติลา
            </button>
          </div>
        </div>
        ...
        <div class="leave-summary-section">
          ...
          <div class="leave-quota-card">
            <div class="leave-quota-item">
              <span>ลาป่วย คงเหลือ</span>
              <span class="quota-value">7 วัน</span>
            </div>
            <div class="leave-quota-item">
              <span>ลากิจ คงเหลือ</span>
              <span class="quota-value">5 วัน</span>
            </div>
            <div class="leave-quota-item">
        ...
        <h3 class="history-header">ประวัติการลา</h3>
...
.leave-quota-item span:first-child {
  font-size: 0.9em;
  color: #666;
}

.leave-quota-item .quota-value {
  font-size: 1.5em;
  font-weight: bold;
  color: #1890ff;
  margin-top: 5px;
