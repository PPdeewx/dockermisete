      ...
      <div class="content-container">
        <div class="content-header">
            ...
            <div class="header-right">
                <button class="action-button green"><i class="fas fa-plus"></i> ลาให้คนอื่น</button>
                <button class="action-button green"><i class="fas fa-plus"></i> ขออนุมัติลา</button>
            </div>
        </div>
        ...
        <div class="profile-and-summary">
            <div class="profile-card">
                ...
                <div class="profile-details">
                    ...
                    <span class="profile-id" v-if="user">รหัส {{ user.role }}</span>
                </div>
            </div>
    ...
    <div class="modal-backdrop">
      <div class="modal-content">
        <div class="modal-header">
          <h3>แก้ไขข้อมูลการลางาน นาย admin admin</h3>
          <button class="modal-close-button red" @click="goTo('/user')">ยกเลิก</button>
        </div>
        <div class="modal-body">
          <div class="form-row">
            <label>พนักงาน :</label>
            <span class="form-text">นาย admin admin</span>
          </div>
          <div class="form-row">
            <label>ประเภทการลา :</label>
            <div class="radio-group">
              <label><input type="radio" name="leaveType" checked> ลากิจ</label>
              <label><input type="radio" name="leaveType"> ลาป่วย</label>
              <label><input type="radio" name="leaveType"> ลาพักร้อน</label>
            </div>
          </div>
          ...
          <div class="form-row">
            ...
            <select class="select-input">
              <option>เลือกผู้อนุมัติการลา</option>
            </select>
          </div>
          <div class="form-row">
          ...
          <button class="edit-button yellow" @click="goTo('/user4')"><i class="fas fa-edit"></i> แก้ไขข้อมูล</button>
        </div>
      </div>
    </div>
  </div>
